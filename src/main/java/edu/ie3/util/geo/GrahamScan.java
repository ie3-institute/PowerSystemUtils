...
public final class GrahamScan {
  ...
  /**
   * Returns the convex hull of the points created from <code>xs</code> and <code>ys</code>. Note
   * that the first and last point in the returned <code>List&lt;java.awt.Point&gt;</code> are the
   * same point.
   *
  ...
  /**
   * Returns the convex hull of the points created from the list <code>points</code>. Note that the
   * first and last point in the returned <code>List&lt;java.awt.Point&gt;</code> are the same
   * point.
   *
   * @param points the list of points.
  ...
  /**
   * Returns the points with the lowest y coordinate. In case more than 1 such point exists, the one
   * with the lowest x coordinate is returned.
   *
   * @param points the list of points to return the lowest point from.
   * @return the points with the lowest y coordinate. In case more than 1 such point exists, the one
   *     with the lowest x coordinate is returned.
   */
   ...
   * in increasing order of the angle they and the lowest point <var>P</var> make with the x-axis.
   * If tow (or more) points form the same angle towards <var>P</var>, the one closest to
   * <var>P</var> comes first.
   *
   ...
   * <code>b</code> and <code>c</code>. More specifically, the cross product <var>C</var> between
   * the 3 points (vectors) is calculated: <var>(b.x-a.x * c.y-a.y) - (b.y-a.y * c.x-a.x)</var> and
   * if <var>C</var> is less than 0, the turn is CLOCKWISE, if <var>C</var> is more than 0, the turn
   * is COUNTER_CLOCKWISE, else the three points are COLLINEAR.
   *
   * @param a the starting point.
   * @param b the second point.
   * @param c the end point.
   * @return the GrahamScan#Turn formed by traversing through the ordered points <code>a</code>,
