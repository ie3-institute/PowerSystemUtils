...
public class QuantityUtil {
  ...
  /***
   * Compares two {@link Quantity}s, if they are equal. Replaces Objects.equals for Quantities,
   * as they cannot be checked on semantic equality with Quantity.equals(Quantity)
   *
   * @param a First quantity to compare
   * @param b Second quantity to compare
   * @param <Q> Type of Quantity
   ...
   */
  public static <Q extends Quantity<Q>> boolean equals(ComparableQuantity<Q> a, ComparableQuantity<Q> b) {
