...
/**
 * Thrown when an operation should be performed on an {@link edu.ie3.util.quantities.EmptyQuantity}
...
public class EmptyQuantityException extends RuntimeException {
  ...
  /**
   * Constructs a {@code EmptyQuantityException} with the specified detail message.
   *
