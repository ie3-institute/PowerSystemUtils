...
public class TimeUtil {
    ...
    public static final TimeUtil withDefaults = new TimeUtil(ZoneId.of("UTC"), Locale.GERMANY, "yyyy-MM-dd HH:mm:ss");
    ...
    public TimeUtil(ZoneId zoneId, Locale locale, String dtfPattern) {
        ...
        this.dateTimeFormatter = DateTimeFormatter.ofPattern(dtfPattern).withZone(zoneId).withLocale(locale);
    }
    ...
    /**
     * Determines the number of quarter hour of the day (starting with 0). The definition of quarter hour relates to
     * something comparable than a right open interval. Example:
     * 00:00:00 = 0
     * ...
     * 00:14:59 = 0
     * 00:15:00 = 1
     ...
     *
     * @param startDateTime
     * @param endDateTime   // todo JH
     * @return
     */
    public double zonedDateTimeDifferenceInSeconds(String startDateTime, String endDateTime) {
        if(startDateTime.length() == 0 || startDateTime.equals("undefined"))
            return UNDEFINED_TIME;
        if(endDateTime.length() == 0 || endDateTime.equals("undefined"))
            return UNDEFINED_TIME;
        return zonedDateTimeDifference(TimeUtil.withDefaults.toZonedDateTime(startDateTime),
                        TimeUtil.withDefaults.toZonedDateTime(endDateTime), ChronoUnit.SECONDS);
    }
     ...
     * @return
     */
    public double zonedDateTimeDifference(ZonedDateTime startDateTime, ZonedDateTime endDateTime, ChronoUnit unit) {
